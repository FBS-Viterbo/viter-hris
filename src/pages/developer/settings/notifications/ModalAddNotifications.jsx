...
const ModalAddNotifications = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/controllers/developers/settings/notifications/notifications.php`
          : `${apiVersion}/controllers/developers/settings/notifications/notifications.php`,
        itemEdit ? "put" : "post",
        values,
      ),
  ...
  const initVal = {
    ...itemEdit,
    first_name: itemEdit ? itemEdit.first_name : "",
    last_name: itemEdit ? itemEdit.last_name : "",
    purpose: itemEdit ? itemEdit.purpose : "",
    email: itemEdit ? itemEdit.email : "",
    email_old: itemEdit ? itemEdit.email : "",
  };
  ...
  const yupSchema = Yup.object({
    ...
    purpose: Yup.string()
      .trim()
      .oneOf(["leave", "overtime"], "Invalid purpose")
      .required("required"),
